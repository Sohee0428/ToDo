...
import com.example.aoppart5chapter01.databinding.ActivityListBinding
import com.example.aoppart5chapter01.presentation.BaseActivity
import com.example.aoppart5chapter01.presentation.detail.DetailActivity
import com.example.aoppart5chapter01.presentation.detail.DetailMode
import com.example.aoppart5chapter01.presentation.view.ToDoAdapter
...
internal class ListActivity : BaseActivity<ListViewModel>(), CoroutineScope {
    ...
    private fun handleSuccessState(state: ToDoListState.Success) = with(binding) {
        ...
        if (state.toDoList.isEmpty()) {
            emptyResultTxt.isGone = false
            recyclerView.isGone = true
        } else {
            emptyResultTxt.isGone = true
